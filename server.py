...
_ORIGIN_APP_ALIASES = {
    ...
    "idea64.exe": ("IntelliJ IDEA", "code"),
    "idea.exe": ("IntelliJ IDEA", "code"),
    "clion.exe": ("CLion", "code"),
    "pycharm64.exe": ("PyCharm", "code"),
    "pycharm.exe": ("PyCharm", "code"),
    "rider64.exe": ("Rider", "code"),
    "goland64.exe": ("GoLand", "code"),
    "webstorm64.exe": ("WebStorm", "code"),
    "phpstorm64.exe": ("PhpStorm", "code"),
    "datagrip64.exe": ("DataGrip", "code"),
    "rubymine64.exe": ("RubyMine", "code"),
    "studio64.exe": ("Android Studio", "code"),
